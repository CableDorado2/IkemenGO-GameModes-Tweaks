...
Description:
This external module implements BOSS RUSH game mode (defeat all opponents that are consider bosses).
...
TODO: Add Boss Fight game mode (defeat a boss character selected) detectable by GameMode trigger as boss and bosscoop.
=======================================================================================================
]]
...
main.t_itemname.boss = function() --Unfinished
	main.f_playerInput(main.playerInput, 1)
	main.t_pIn[2] = 1
	main.charparam.ai = true
	main.charparam.music = true
...
main.t_itemname.bosscoop = function() --Unfinished
	main.coop = true
	main.charparam.ai = true
	main.charparam.music = true
	main.charparam.rounds = true
