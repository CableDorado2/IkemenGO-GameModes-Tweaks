...
Description:
This external module implements TIME CHALLENGE game mode (defeat selected opponent beating previous time record).
...
--[[
This code creates data out of optional [TimeChallengeResultsBGdef] sff file.
...
reusing logic already declared for Time Attack Mode (refer to start.lua)
]]
